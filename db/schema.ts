...
export const annotations = sqliteTable(
  "annotations",
  {
    ...
    selectionType: text("selection_type").notNull().default("element"),
    regionJson: text("region_json"),
    highlightedElementsJson: text("highlighted_elements_json"),
    agentState: text("agent_state").notNull().default("unseen"),
